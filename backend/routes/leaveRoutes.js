...
router.get('/download-usage', ctrl.downloadLeaveUsage);
router.get('/download-workbook/excel', ctrl.downloadLeaveWorkbookExcel);
router.get('/download-workbook/pdf', ctrl.downloadLeaveWorkbookPdf);
